...
export class OrderJourney {
  ...
  _constructStep(step: OrderJourneyStep): StructuredOrderStep {
    ...
    switch (step.stepStatus.valueOf()) {
      case OrderJourneyStepStatus.REQUESTED.valueOf(): {
        return {
          ...baseData,
          extraData: [
            {
      ...
      case OrderJourneyStepStatus.PILOT_REQUESTED.valueOf(): {
        return {
          ...baseData,
          clickable: false,
          extraData: [
      ...
      case OrderJourneyStepStatus.PILOT_ASSIGNED.valueOf(): {
        return {
          ...baseData,
          clickable: true,
          extraData: [],
      ...
      case OrderJourneyStepStatus.CANCELLED.valueOf(): {
        return {
          ...baseData,
          extraData: [
