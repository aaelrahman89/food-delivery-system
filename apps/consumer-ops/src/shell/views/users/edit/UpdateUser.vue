              ...
              <v-row>
                ...
                <v-col cols="12" sm="7" md="8">
                  <vg-text-field
                    ...
                    label="USERS_PROFILE_UPDATE_USER_NAME"
                    type="text"
                    required
                    outlined
                    max-width="100%"
                  ...
                  <vg-text-field
                    ...
                    label="USERS_PROFILE_UPDATE_EMAIL"
                    type="text"
                    required
                    outlined
                    max-width="100%"
                  ...
                  <vg-text-field
                    ...
                    label="USERS_PROFILE_UPDATE_MOBILE_NO"
                    type="tel"
                    required
                    outlined
                    max-width="100%"
                  ...
                  <vg-select
                    ...
                    label="USERS_PROFILE_UPDATE_ROLE"
                    required
                    multiple
                    outlined
                    max-width="100%"
...
import { UserUpdatePM } from '../../../../core/presentation-models/users/UserUpdatePM';
  ...
  computed: {
    breadcrumbs() {
      return [
        ...
        {
          routeName: ROUTE_NAMES.USERS_PROFILE_UPDATE,
          text: this.$t('USERS_PROFILE_UPDATE'),
        },
      ];
    },
  },
