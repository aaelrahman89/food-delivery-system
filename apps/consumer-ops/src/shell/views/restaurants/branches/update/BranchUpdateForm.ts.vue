<template>
  <vg-content :pm="pm" :breadcrumbs="breadcrumbs">
    <vg-panel :title="$t('ONLINE_ORDERING_BRANCHES_UPDATE_BRANCH_INFO')">
      <div class="branch-update-form">
        <vg-panel>
          <div class="branch-update-form__switch-component">
            <div class="branch-update-form__switch-component__switch-label">
              {{ $t('ONLINE_ORDERING_BRANCHES_UPDATE_ENABLE_BRANCH_STATUS') }}
            </div>
            <vg-switch
              v-model="pm.form.active"
              :hide-details="true"
              class="branch-update-form__switch-component__switch-trigger"
            ></vg-switch>
          </div>
        </vg-panel>
        <vg-panel :title="$t('ONLINE_ORDERING_BRANCHES_UPDATE_DISPLAY_NAME')">
          <div class="branch-update-form__rows__row-items">
            <vg-text-field
              v-model="pm.form.displayName.en"
              :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_ENGLISH')"
            ...
            <vg-text-field
              ...
              :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_ARABIC')"
            ...
            <vg-text-field
              ...
              :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_LABEL')"
        ...
        <vg-panel :title="$t('ONLINE_ORDERING_BRANCHES_UPDATE_ATTRIBUTES')">
          <div class="branch-update-form__rows">
            <div class="branch-update-form__rows__row-items">
              <vg-time-picker
                v-model="pm.form.opensAt"
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_OPENS_AT')"
              ...
              <vg-time-picker
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_CLOSES_AT')"
              ...
              <vg-text-field
                ...
                :label="
                  $t('ONLINE_ORDERING_BRANCHES_UPDATE_MINIMUM_ORDER_VALUE')
                "
            ...
            <div class="branch-update-form__rows__row-items">
              <vg-text-field
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_DELIVERY_FEES')"
              ...
              <vg-text-field
                ...
                :label="
                  $t('ONLINE_ORDERING_BRANCHES_UPDATE_AVERAGE_BASKET_SIZE')
                "
        ...
        <vg-panel :title="$t('ONLINE_ORDERING_BRANCHES_UPDATE_TAGS')">
        ...
        <vg-panel :title="$t('ONLINE_ORDERING_BRANCHES_UPDATE_LOCATION')">
          <vg-grid gap-size="mid" columns="1fr 1fr 1fr">
            <vg-flex gap-size="large" flex-direction="column">
              <vg-select
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_COUNTRY')"
                max-width="100%"
                outlined
                required
              ...
              <vg-select
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_AREA')"
                max-width="100%"
                outlined
                required
              >
              ...
              <vg-text-field
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_BUILDING')"
                max-width="100%"
                type="text"
                hide-details
                outlined
            ...
            <vg-flex gap-size="large" flex-direction="column">
              <vg-select
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_CITY')"
                max-width="100%"
                outlined
                required
              ...
              <vg-text-field
                ...
                :label="$t('ONLINE_ORDERING_BRANCHES_UPDATE_STREET')"
                max-width="100%"
                type="text"
                hide-details
                outlined
            ...
            <vg-flex gap-size="large" flex-direction="column">
              ...
              <vg-button expand outlined @click="pm.openMapModal()">
                {{ $t('ONLINE_ORDERING_BRANCHES_UPDATE_UPDATE_LOCATION') }}
              </vg-button>
            </vg-flex>
          </vg-grid>
        </vg-panel>
        ...
        <vg-panel :title="$t('ONLINE_ORDERING_BRANCHES_UPDATE_CONTACTS')">
          <div
            v-if="pm.form.contactPersons.length === 0"
            class="branch-update-form__contacts-empty"
          >
            <div class="branch-update-form__contacts-empty__body">
              <div class="branch-update-form__contacts-empty__title">
                {{ $t('ONLINE_ORDERING_BRANCHES_UPDATE_ADD_AT_LEAST_ONE') }}
              </div>
              <vg-button
                color="primary"
                outlined
              ...
              >
                {{ $t('ONLINE_ORDERING_BRANCHES_UPDATE_ADD_CONTACT') }}
              </vg-button>
            </div>
          </div>
          <div v-if="pm.form.contactPersons.length > 0">
            <div class="branch-update-form__contacts">
              ...
              ></contact-person-simple-table>
              <div class="branch-update-form__contacts__footer">
                <vg-button
                  color="primary"
                  outlined
                  @click="pm.openContactPersonForm()"
        ...
        <div class="branch-update-form__footer">
          <vg-button color="primary" outlined @click="discardChanges()">
            {{ $t('ONLINE_ORDERING_BRANCHES_UPDATE_DISCARD_CHANGES') }}
          </vg-button>
          <vg-button
            color="primary"
            ...
            @click="submit"
          >
            {{ $t('ONLINE_ORDERING_BRANCHES_UPDATE_SAVE_CHANGES') }}
          </vg-button>
        </div>
      </div>
    </vg-panel>
...
import { BranchUpdatePM } from '../../../../../core/presentation-models/branches/BranchUpdatePM';
import {
  GeoJSONPoint,
    ...
    breadcrumbs(): NavSegment[] {
      return [
        ...
        },
        {
          ...
          routeParams: { ...this.$route.params },
          text: this.$t(
            this.pm.branchDetails?.displayName.en &&
              this.pm.branchDetails?.displayName.ar
              ? this.pm.branchDetails?.displayName
              : this.pm.branchDetails?.label
          ),
        },
        {
          routeName:
            ROUTE_NAMES.ONLINE_ORDERING_VENDOR_ONLINE_PROFILE_BRANCHES_UPDATE,
          routeParams: { ...this.$route.params },
          text: this.$t('ONLINE_ORDERING_BRANCHES_UPDATE'),
        },
      ];
    },
  },
