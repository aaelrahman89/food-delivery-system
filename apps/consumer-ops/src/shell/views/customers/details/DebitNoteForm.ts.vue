  ...
  <vg-overlay :open="open" type="bottom-sheet" @backdrop="backdrop">
    <v-form ref="form" @submit.prevent="submit">
      <div class="debit-note-form">
        <div class="debit-note-form__header">
          <h1>{{ $t('DEBIT_NOTE_FORM_HEADER_CREATION') }}</h1>
        </div>
        <div class="debit-note-form__body">
          <div class="debit-note-form__input">
            <vg-text-field
              ...
              :label="$t('DEBIT_NOTE_FORM_DESCRIPTION') + '*'"
            ></vg-text-field>
          </div>
          <div class="debit-note-form__input">
            <vg-text-field
              ...
              :label="$t('DEBIT_NOTE_FORM_AMOUNT') + '*'"
            ></vg-text-field>
          </div>
        </div>
        <div class="debit-note-form__footer">
...
<script lang="ts">
import Vue from 'vue';
import { DebitNoteForm } from '../../../../core/models/DebitCreditNotes';
