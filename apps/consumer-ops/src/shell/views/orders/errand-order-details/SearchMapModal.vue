            ...
            <vg-flex class="px-2 py-6" gap-size="mid">
              <v-col cols="12">
                <h3 class="geomap-header">
                  {{ $t('ONLINE_ORDER_DETAILS_STRUCTURE_ORDER_GEOMAP_HEADER') }}
                </h3>
                  ...
                  >
                    <div class="geomap-autocomplete">
                      <v-autocomplete
                        ...
                        :label="
                          $t(
                            'ONLINE_ORDER_DETAILS_STRUCTURE_ORDER_GEOMAP_SEARCH'
                          )
                        "
                        type="text"
                        @input="select"
                  ...
                  <div class="buttons-container">
                    <div class="vg-margin-inline-end--mid">
                      <vg-button expand outlined @click="discard">
                        {{
                          $t(
                            'ONLINE_ORDER_DETAILS_STRUCTURE_ORDER_GEOMAP_CANCEL'
                          )
                        }}
                      </vg-button>
                    </div>
                    <div>
                      ...
                      >
                        {{
                          $t(
                            'ONLINE_ORDER_DETAILS_STRUCTURE_ORDER_GEOMAP_CONTINUE'
                          )
                        }}
                      </vg-button>
                    </div>
