    ...
    <v-form v-if="pm" @submit.prevent="submit">
      <div class="tax-tiers-form">
        <div class="tax-tiers-form__header">
          <h1>{{ $t('TAX_TIER_FORM_HEADER_CREATION') }}</h1>
        </div>
...
<script lang="ts">
import Vue from 'vue';
import { TaxTierCreationPM } from '../../../../core/presentation-models/tax-tiers/TaxTierCreationPM';
