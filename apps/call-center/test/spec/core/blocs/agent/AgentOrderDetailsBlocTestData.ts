  ...
  return {
    inCaseInitializeSucceeded: (): InitializeActionSucceededMessages => {
      ...
      const initializeLoadingMessage =
        (function constructInitializeLoadingMessage(): AgentOrderDetailsMessage {
          const msg = defaultMessage.clone();
          msg.action = new AgentOrderDetailsAction({
            type: 'INITIALIZE',
          });
      ...
      const initializeOrderDetailsDoneMessage =
        (function constructInitializeDoneMessage(): AgentOrderDetailsMessage {
    ...
    inCaseInitializeFailed: (): InitializeActionFailedMessages => {
      const defaultMessage = new AgentOrderDetailsMessage();
      const initializeLoadingMessage =
        (function constructSecondMessage(): AgentOrderDetailsMessage {
          const msg = defaultMessage.clone();
          msg.action = new AgentOrderDetailsAction({
            type: 'INITIALIZE',
          });
      ...
      const initializeOrderDetailsProblematicMessage =
        (function constructThirdMessage(): AgentOrderDetailsMessage {
          const msg = initializeLoadingMessage.clone();
...
interface InitializeActionSucceededMessages {
  defaultMessage: AgentOrderDetailsMessage;
  initializeLoadingMessage: AgentOrderDetailsMessage;
  initializeOrderDetailsDoneMessage: AgentOrderDetailsMessage;
  initializeOrderJourneyDoneMessage: AgentOrderDetailsMessage;
}
interface InitializeActionFailedMessages {
  defaultMessage: AgentOrderDetailsMessage;
  initializeLoadingMessage: AgentOrderDetailsMessage;
  initializeOrderDetailsProblematicMessage: AgentOrderDetailsMessage;
  initializeOrderJourneyProblematicMessage: AgentOrderDetailsMessage;
}
