...
} from '../../../../../src/core/blocs/supervisor/live-orders/SupervisorLiveOrdersListMessage';
...
export function initializeActionMessages(
  ...
  return {
    inCaseFetchingOrdersSucceeded: (): SuccessfulInitializeActionMessages => {
      const defaultMessage = new SupervisorLiveOrdersListMessage();
      const initializeLoadingMessage =
        (function constructInitializeLoadingMessage(): SupervisorLiveOrdersListMessage {
          const msg = defaultMessage.clone();
          msg.action = new SupervisorOrdersListAction({
            type: 'INITIALIZE',
          });
      ...
      const initializeQueuedOrdersDoneMessage =
        (function constructInitializeDoneMessage(): SupervisorLiveOrdersListMessage {
    ...
    inCaseFetchingOrdersFailed:
      (): InitializeActionFailedFetchingTasksMessages => {
        const defaultMessage = new SupervisorLiveOrdersListMessage();
        const initializeLoadingMessage =
          (function constructSecondMessage(): SupervisorLiveOrdersListMessage {
            const msg = defaultMessage.clone();
            msg.action = new SupervisorOrdersListAction({
              type: 'INITIALIZE',
            });
        ...
        const initializeQueuedOrdersProblematicMessage =
          (function constructThirdMessage(): SupervisorLiveOrdersListMessage {
            const msg = initializeLoadingMessage.clone();
...
interface SuccessfulInitializeActionMessages {
  defaultMessage: SupervisorLiveOrdersListMessage;
  initializeLoadingMessage: SupervisorLiveOrdersListMessage;
  initializeQueuedOrdersDoneMessage: SupervisorLiveOrdersListMessage;
  initializeWorkingOrdersDoneMessage: SupervisorLiveOrdersListMessage;
  initializeScheduledOrdersDoneMessage: SupervisorLiveOrdersListMessage;
}
interface InitializeActionFailedFetchingTasksMessages {
  defaultMessage: SupervisorLiveOrdersListMessage;
  initializeLoadingMessage: SupervisorLiveOrdersListMessage;
  initializeQueuedOrdersProblematicMessage: SupervisorLiveOrdersListMessage;
  initializeWorkingOrdersProblematicMessage: SupervisorLiveOrdersListMessage;
  initializeScheduledOrdersProblematicMessage: SupervisorLiveOrdersListMessage;
}
interface SuccessfulFetchOrdersActionMessages {
  defaultMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersLoadingMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersQueuedOrdersDoneMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersWorkingOrdersDoneMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersScheduledOrdersDoneMessage: SupervisorLiveOrdersListMessage;
}
interface FetchOrdersActionFailedFetchingTasksMessages {
  defaultMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersLoadingMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersQueuedOrdersProblematicMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersWorkingOrdersProblematicMessage: SupervisorLiveOrdersListMessage;
  fetchOrdersScheduledOrdersProblematicMessage: SupervisorLiveOrdersListMessage;
}
