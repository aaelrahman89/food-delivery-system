...
import { SupervisorLiveOrdersListBloc } from '../../../../../src/core/blocs/supervisor/live-orders/SupervisorLiveOrdersListBloc';
import {
...
} from './SupervisorLiveOrdersListBlocTestData';
import { kvStorage } from '@survv/pwa/shell/kv-storage-impl';
import { notificationService } from '@survv/commons/shell/services/notificationService';
import { take } from 'rxjs/operators';
import { wiremock } from '@survv/commons/test/utils/wiremock';

describe('SupervisorOrdersListBloc Unit', function () {
  let bloc: SupervisorLiveOrdersListBloc;
  ...
  describe('on INITIALIZE', function () {
    it('initializes correctly', function (done) {
      ...
      $sb
        .stub(OrdersRepoImpl.prototype, 'listSupervisorQueuedOrders')
      ...
      const messages: SupervisorLiveOrdersListMessage[] = [];
      (bloc.outbox() as Observable<SupervisorLiveOrdersListMessage>)
        .pipe(take(5))
        .subscribe({
          next: (message: SupervisorLiveOrdersListMessage) => {
...
describe('SupervisorOrdersListBloc Integration', function () {
  let bloc: SupervisorLiveOrdersListBloc;
  const localizationService = new LocalizationServiceMockImpl();
