import AgentRoutes from './shell/views/agent/routes.nc';
import SupervisorRoutes from './shell/views/supervisor/routes.nc';
...
export const routes = [
  {
    ...
    children: [
      ...
      ...SupervisorRoutes,
      {
        ...
        component: () => import('./shell/views/Redirect.ts.vue'),
        meta: {
          allowedRoles: 'any',
        },
      },
