<template>
  <div class="vg-app-shell">
    ...
    <main>
      <vg-app-menu
        v-allowed-roles="[UserRole.CALL_CENTER_SUPER_ADMIN]"
...
<script lang="ts">
import ConsumerVendorAppBar from './ConsumerVendorAppBar.ts.vue';
...
export default Vue.extend({
  name: 'ConsumerVendorAppShell',
  components: {
    ConsumerVendorAppBar,
    VgAppMenu,
  },
  props: {
    logoUrl: {
