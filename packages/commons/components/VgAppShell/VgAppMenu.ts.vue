      ...
      <vg-flex flex-direction="column" no-wrap gap-size="mid">
        ...
        <div>
          <vg-button
            :expand="!collapsed"
            color="primary"
            class="vg-app-menu__sign-out"
            large
            :icon="collapsed"
            @click="onSignOut"
          >
            <div
              class="vg-app-menu__sign-out__text"
              :class="signOutTextClasses"
            >
              {{ $t('BUTTON_LABEL_SIGN_OUT') }}
            </div>
            <vg-svg
              :svg-props="signOutSvgProps"
              :src="signOutIcon"
              height="24px"
              class="vg-app-menu__sign-out__icon"
            ></vg-svg>
          </vg-button>
        </div>
      </vg-flex>
